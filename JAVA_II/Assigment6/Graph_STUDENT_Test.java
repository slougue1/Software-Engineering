...
public class Graph_STUDENT_Test {
	...
	public void setUp() throws Exception {
		 graph = new Graph();
		  ...
		  graph.addEdge(town[1], town[2], 2, "Road_21");
		  graph.addEdge(town[1], town[3], 1, "Road_13");
		  graph.addEdge(town[2], town[5], 6, "Road_41");
	...
	public void testGetEdge() {
		assertEquals(new Road(town[1], town[2],2, "Road_21"), graph.getEdge(town[1], town[2]));
	...
	public void testEdgeSet() {
		...
		assertEquals("Road_21", roadArrayList.get(1));
		assertEquals("Road_13", roadArrayList.get(0));
		assertEquals("Road_36", roadArrayList.get(2));
	}
