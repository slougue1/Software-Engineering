...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(s, doubleQ.dequeue());
			assertEquals(o, doubleQ.dequeue());
			assertEquals(k, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(n));
	...
	public void testToStringStudent() {
		...
		try 
		{
			assertEquals("1.52.53.5", doubleQ.toString());
			doubleQ.enqueue(i);
			assertEquals("1.52.53.54.5", doubleQ.toString());
			doubleQ.enqueue(n);
			assertEquals("1.52.53.54.55.5", doubleQ.toString());
		}
		catch(Exception e)
		{
