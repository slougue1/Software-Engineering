...
public class NotationStackTest {
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(k, doubleS.pop());
			assertEquals(o, doubleS.pop());
			assertEquals(s, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(n));
	...
	public void testToStringStudent() {
		...
		try 
		{
		assertEquals("1.52.53.5", doubleS.toString());
		doubleS.push(i);
		assertEquals("1.52.53.54.5", doubleS.toString());
		doubleS.push(n);
		assertEquals("1.52.53.54.55.5", doubleS.toString());
		}
		catch (Exception e)
		{
